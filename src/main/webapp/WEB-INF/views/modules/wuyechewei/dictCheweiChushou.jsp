...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wuyechewei/dictChewei/form?id=${dictChewei.id}">
			车位<shiro:hasPermission name="wuyechewei:dictChewei:sale">出售</shiro:hasPermission>
	...
	<form:form id="inputForm" modelAttribute="dictChewei" action="${ctx}/wuyechewei/dictChewei/chushou" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="xiaoshousj" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${dictTaohu.xiaoshousj}" pattern="yyyy-MM-dd"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="xiaoshoujg" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
